...
Frontend-разработчик, специализируюсь на:

-   Разработке пользовательских интерфейсов на React.
-   Создании адаптивных и кросс-браузерных решений
-   Оптимизации производительности веб-приложений
    А также:
-   Понимаю полный цикл разработки — от идеи до запуска.
-   Мой фокус — не только на функциональности, но и на производительности, доступности и качестве кода.

**Моя ценность для команды:**

-   🚀 активно изучаю новые технологии и инструменты, что позволяет мне быстро начинать приносить пользу.
-   📚 не боюсь взять на себя сложные задачи, чтобы разгрузить команду и улучшить продукт.
-   👥 ответственно подхожу к работе, делюсь найденными решениями и стремлюсь к тому, чтобы кодовая база проекта была понятна каждому.
-   😊 **не имею моральных травм и накопившихся обид к миру**.

**Ключевые достижения:**

-   🚀 Разработал мобильное приложение **Misbox [IOS](https://apps.apple.com/ru/app/misbox/id1569062876) [android](https://play.google.com/store/apps/details?id=ru.tiomed.misbox&hl=en.)** (React Native/Expo) с аудиторией **2000+ врачей**
    -   Полный цикл разработки от идеи до релиза
-   🛒 Участвовал в командной разработке коммерческого интернет-магазина [велосипедов](https://veloman.by/) на **React + TypeScript + Tailwind CSS**
    -   реализовал 15+ переиспользуемых UI-компонентов - сверстал 6+ React-компонентов - ускорил процесс разработки за счет системы StoryBook - адаптировал интерфейс под мобильные устройства
