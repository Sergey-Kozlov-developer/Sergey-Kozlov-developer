...
-   🚀 Разработал мобильное приложение **Misbox [IOS](https://apps.apple.com/ru/app/misbox/id1569062876) [android](https://play.google.com/store/apps/details?id=ru.tiomed.misbox&hl=en.)** (React Native/Expo) с аудиторией **2000+ врачей** - Полный цикл разработки от идеи до релиза
-   🛒 Участвовал в командной разработке коммерческого интернет-магазина [велосипедов](https://veloman.by/) на **React + TypeScript + Tailwind CSS** - реализовал 15+ переиспользуемых UI-компонентов - сверстал 6+ React-компонентов - ускорил процесс разработки за счет системы StoryBook - адаптировал интерфейс под мобильные устройства
