...
Frontend-разработчик с коммерческим опытом разработки веб-приложений в B2B-сервисах и медицинской сфере.
Специализируюсь на React и TypeScript, разработке интерфейсов для сложных пользовательских сценариев, работе с бизнес-логикой и оптимизации производительности.
Имею опыт работы с продуктами для реальных компаний и пользователей, влияния на ключевые метрики и поддержки проектов в продакшене.
